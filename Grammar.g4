...
for_statement: FOR SPACE* init=assignment_statement SPACE* SEMICOLON SPACE* cond=expression SPACE* SEMICOLON SPACE* update=expression SPACE* ')' BRACE_LEFT NEWLINE* SPACE* body=statements SPACE* NEWLINE* BRACE_RIGHT;
